  ...
  highlight: function (node, re, nodeName, className) {
    ...
    function addPopover(highlighter){
      $.each(highlighter.find('.aniways-highlight'), function(index, span){
        span = $(span)
        span.attr('data-phrase', span.text());
...
jQuery.fn.highlight = function (words, options) {
  var settings = { className: 'aniways-highlight', element: 'span', caseSensitive: false, wordsOnly: true };
...
window.Aniways = {
  init: function(){
    if(Aniways.mapping !== null){
      this.aniways_mapping = Aniways.parseMappings()
    }
    if (document.getElementsByClassName('aniways-wall').length > 0){
      ...
      $('.aniways-div').on('input', function(){
        if(Aniways.aniways_mapping !== null){
          $(this).highlight(Object.keys(Aniways.aniways_mapping));
        }
      });
  ...
  parseMappings: function(){
    ...
    Object.keys(Aniways.mapping.phrasesToIcons).forEach(function (phraseName) {
      ...
      if (iconPathsToReplaceTheEntirePhrase) {
        aniways_mappings[phraseName] = {};
        aniways_mappings[phraseName]['iconPaths'] = iconPathsToReplaceTheEntirePhrase;
      }
    });
    return aniways_mappings;
  },
  ...
  unicodeDecoding: function(message){
    if (this.mapping === null || this.assetsNamesToUrls === null) { return message; }
    ...
    for (var i=0; i<messageEncodingData.data.length; i++ ) {
      ...
      var imagePath = this.assetsNamesToUrls[this.mapping.iconIdsToNames[encodingData.imageId]];
  ...
  setMapping:function(){
    if (this.readyState === 4) {
      if (this.status === 200) {
        ...
        Aniways.aniways_mapping = Aniways.parseMappings();
  ...
  generatePopupHtml: function (spanNode){
    ...
    var imageCount = Aniways.aniways_mapping[phrase]['iconPaths'].length
      for (var i=0; i< imageCount; i++){
        assets += "<img class='aniways-popover-image' onClick=Aniways.replaceWithImage(event) src='http://az493648.vo.msecnd.net/aniways-assets/android/ldpi/" + Aniways.aniways_mapping[phrase]['iconPaths'][i] + "' data-phrase=" + phrase + "></img>"
      }
