  ...
  generatePopupHtml: function (spanNode){
    ...
    var imageCount = Aniways.aniways_mapping[phrase]['iconPaths'].length
      for (var i=0; i< imageCount; i++){
        assets += "<img class='aniways-popover-image' onClick=Aniways.replaceWithImage() src='http://az493648.vo.msecnd.net/aniways-assets/android/ldpi/" + Aniways.aniways_mapping[phrase]['iconPaths'][i] + "' data-phrase=" + phrase + "></img>"
      }
